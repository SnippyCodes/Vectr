...
export default function NovaChat({ repoName = '', issuesContext = [] }) {
    ...
    return (
        <div className="flex flex-col h-full rounded-xl overflow-hidden" style={{
            background: 'linear-gradient(135deg, rgba(5,5,15,0.95), rgba(10,10,25,0.9))',
            border: '1px solid transparent',
            borderImage: 'linear-gradient(180deg, #ec4899, #8b5cf6, #22d3ee) 1',
        }}>
            {/* Header */}
            ...
            <div className="p-3 flex items-center gap-2" style={{ borderTop: '1px solid rgba(30,58,95,0.5)' }}>
                ...
                <button
                    ...
                    className="text-accent-cyan hover:text-accent-green transition-colors disabled:opacity-30"
