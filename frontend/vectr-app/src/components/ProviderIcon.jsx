...
/**
 * Clean developer-grade SVG icons for LLM providers.
 * Completely replaces emojis with crisp vector geometry.
 */
export default function ProviderIcon({ providerId, className = "w-4 h-4" }) {
    switch (providerId) {
        case 'groq':
            return (
