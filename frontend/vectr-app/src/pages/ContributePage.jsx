        ...
        <>
            ...
            {showLangModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => { }}>
                    <div className="glass-card-accent w-full max-w-2xl p-6 m-4 fade-in" role="dialog" aria-label="Select Language">
            ...
            {showOrgModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="glass-card-accent w-full max-w-2xl p-6 m-4 fade-in max-h-[80vh] flex flex-col" role="dialog" aria-label="Select Organization">
