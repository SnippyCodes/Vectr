            ...
            <header className="flex items-center justify-between px-6 py-4 border-b border-border-default/30">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        id="send-pr-btn"
                    >
                        {sent ? '✓ PR Sent!' : sending ? 'Sending...' : 'Send PR'}
                    </button>
                </div>
            </header>
                    ...
                    <div className="glass-card p-4">
                        ...
                        <div className="mt-3">
                            <textarea
                                ...
                                className="w-full bg-bg-input text-text-secondary text-xs rounded-lg p-3 border border-border-default/50 outline-none resize-none font-mono"
                                rows={6}
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="input-dark !rounded-lg text-sm" placeholder="PR Title"
                                />
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-bg-input text-text-secondary text-sm rounded-lg p-4 border border-border-default/50 outline-none resize-none font-mono"
